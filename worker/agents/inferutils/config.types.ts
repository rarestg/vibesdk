 ...
 */
export const AIModels = Object.fromEntries(Object.entries(MODELS_MASTER).map(([key, value]) => [key, value.id])) as {
  [K in keyof typeof MODELS_MASTER]: (typeof MODELS_MASTER)[K]['id'];
};
