...
export class AnalyticsController extends BaseController {
  ...
  static async getUserAnalytics(
    ...
    try {
      ...
      if (error instanceof AnalyticsError) {
        return AnalyticsController.createErrorResponse<UserAnalyticsResponseData>(error.message, error.statusCode);
      }

      return AnalyticsController.createErrorResponse<UserAnalyticsResponseData>('Failed to fetch user analytics', 500);
    }
  }
  ...
  static async getAgentAnalytics(
    ...
    try {
      ...
      if (error instanceof AnalyticsError) {
        return AnalyticsController.createErrorResponse<AgentAnalyticsResponseData>(error.message, error.statusCode);
      }
