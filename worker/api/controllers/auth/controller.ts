...
export class AuthController extends BaseController {
  ...
  static async initiateOAuth(
    ...
    try {
      ...
      const authService = new AuthService(env);
      const authUrl = await authService.getOAuthAuthorizationUrl(validatedProvider, request, intendedRedirectUrl);
  ...
  static async handleOAuthCallback(
    ...
    try {
      ...
      const authService = new AuthService(env);
      const result = await authService.handleOAuthCallback(validatedProvider, code, state, request);
