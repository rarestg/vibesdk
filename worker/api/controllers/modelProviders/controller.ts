...
export class ModelProvidersController extends BaseController {
  ...
  ): Promise<ControllerResponse<ApiResponse<ModelProvidersListData>>> {
    try {
  ...
  static async getProvider(
    ...
    _ctx: ExecutionContext,
    context: RouteContext,
  ): Promise<ControllerResponse<ApiResponse<ModelProviderData>>> {
    try {
      const user = context.user!;
  ...
  ): Promise<ControllerResponse<ApiResponse<ModelProviderCreateData>>> {
    try {
      ...
      return ModelProvidersController.createErrorResponse<ModelProviderCreateData>('Failed to create provider', 500);
    }
  }
  ...
  static async updateProvider(
    ...
    _ctx: ExecutionContext,
    _context: RouteContext,
  ): Promise<ControllerResponse<ApiResponse<ModelProviderUpdateData>>> {
    try {
      const url = new URL(request.url);
      const providerId = url.pathname.split('/').pop();
  ...
  static async deleteProvider(
    ...
    _ctx: ExecutionContext,
    _context: RouteContext,
  ): Promise<ControllerResponse<ApiResponse<ModelProviderDeleteData>>> {
    try {
      const url = new URL(request.url);
      const providerId = url.pathname.split('/').pop();
  ...
  static async testProvider(
    ...
    _ctx: ExecutionContext,
    _context: RouteContext,
  ): Promise<ControllerResponse<ApiResponse<ModelProviderTestData>>> {
    try {
