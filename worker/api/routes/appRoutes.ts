...
export function setupAppRoutes(app: Hono<AppEnv>): void {
  ...
  appRouter.get(
    '/favorites',
    setAuthLevel(AuthConfig.authenticated),
    adaptController(AppController, AppController.getFavoriteApps),
  );
  ...
  appRouter.post(
    '/:id/star',
    setAuthLevel(AuthConfig.authenticated),
    adaptController(AppViewController, AppViewController.toggleAppStar),
  );
  ...
  appRouter.post(
    '/:id/favorite',
    setAuthLevel(AuthConfig.authenticated),
    adaptController(AppController, AppController.toggleFavorite),
  );
  ...
  appRouter.post(
    '/:id/git/token',
    setAuthLevel(AuthConfig.ownerOnly),
    adaptController(AppViewController, AppViewController.generateGitCloneToken),
  );
