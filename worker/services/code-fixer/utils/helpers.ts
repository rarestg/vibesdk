 ...
 */
export function createUnfixableIssue(issue: CodeIssue, reason: string): UnfixableIssue {
  return {
 ...
 */
export function handleFixerError(issue: CodeIssue, error: Error, fixerName: string): UnfixableIssue {
