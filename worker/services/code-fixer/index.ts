...
import { CodeFixResult, FixerContext, FileMap, ProjectFile, FixerRegistry } from './types';
 ...
 */
export function fixProjectIssues(allFiles: FileObject[], issues: CodeIssue[]): CodeFixResult {
  try {
    ...
    const results = applyFixesSequentially(context, sortedIssues, fixerRegistry);
 ...
 */
function addUnfixableIssues(results: CodeFixResult, preSeparatedUnfixableIssues: CodeIssue[]): CodeFixResult {
