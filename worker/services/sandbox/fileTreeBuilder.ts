...
export class FileTreeBuilder {
   ...
   */
  static generateFindExclusions(options?: { excludeDirs?: string[]; excludeFiles?: string[] }): {
   ...
   * @returns Root node of the file tree
   */
  private static buildFromPathsWithTypes(paths: string[], filePaths: Set<string>, rootPath: string = ''): FileTreeNode {
    // Create root node
