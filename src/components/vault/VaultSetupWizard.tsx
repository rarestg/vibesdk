  ...
  if (step === 'recovery' && recoveryCodes) {
    return (
      <div className="p-6">
        ...
        <RecoveryCodesDisplay codes={recoveryCodes} onConfirm={() => onComplete?.()} showWarning variant="inline" />
            ...
            >
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-muted-foreground mt-1">Touch ID / Face ID / security key.</div>
                </div>
              </div>
            </button>
          )}
