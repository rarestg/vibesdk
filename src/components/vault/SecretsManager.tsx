      ...
      <>
        <Card id={id} className={className}>
          <CardHeader>
            ...
            <CardDescription>Set up your encrypted vault to securely store API keys and secrets.</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <DialogContent>
          ...
          <div className="mt-4">
            {isLoadingValue ? (
              ...
              <code className="block p-3 bg-muted rounded-md break-all font-mono text-sm">{viewingSecret?.value}</code>
            )}
          </div>
        </DialogContent>
      </Dialog>
