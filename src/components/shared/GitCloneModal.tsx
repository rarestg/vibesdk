            ...
            <>
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <Button variant="ghost" size="icon" className="h-8 w-8" onClick={() => copyCommand(gitCloneCommand)}>
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <Button variant="ghost" size="icon" className="h-8 w-8" onClick={() => copySetup(setupCommands)}>
                    {copiedSetup ? <Check className="h-4 w-4 text-green-400" /> : <Copy className="h-4 w-4" />}
                  </Button>
                </div>
                  ...
                  <div className="flex items-start gap-3 p-4 rounded-lg bg-bg-4 border border-border-primary">
                    ...
                    <div className="flex-1 space-y-1">
                      ...
                      <p className="text-sm text-text-tertiary">
                        Generate a temporary access token to clone this repository. The token expires in 1 hour.
                      </p>
                    </div>
                  </div>
                ...
                <>
                      ...
                      {!tokenRevealed && (
                        ...
                        >
                          <div className="flex items-center gap-2 text-text-primary">
                            ...
                            <span className="text-sm font-medium">Click to reveal token</span>
                          </div>
                        </button>
                      )}
                    </div>
                  ...
                  <div className="flex items-center gap-2 p-3 rounded-lg bg-bg-4 border border-border-primary">
                    ...
                    <span className="text-sm text-text-secondary">
                      Token expires in: <span className="font-medium text-text-primary">{timeRemaining}</span>
                    </span>
                  </div>
                  ...
                  <Button onClick={handleGenerateToken} variant="outline" className="w-full" disabled={isGenerating}>
                    {isGenerating ? (
                      <>
                        <Loader2 className="h-4 w-4 animate-spin mr-2" />
                        Generating...
