  ...
  return (
    <SidebarMenuItem className="group/app-item">
      ...
      {!isCollapsed && showActions && (
        <SidebarMenuAction asChild className="opacity-0 -mr-2 group-hover/app-item:opacity-100 transition-opacity">
          <AppActionsDropdown appId={app.id} appTitle={app.title} size="sm" className="h-6 w-6" showOnHover={false} />
        </SidebarMenuAction>
      )}
    </SidebarMenuItem>
  );
                      ...
                      <TooltipTrigger asChild>
                        <button
                          className={cn(
                            ...
                            isCollapsed ? 'justify-center bg-accent' : 'justify-start bg-accent',
                          )}
                          onClick={() => {
                        ...
                        >
                          ...
                          {!isCollapsed && <span className="font-medium text-neutral-50">New build</span>}
                        </button>
                      </TooltipTrigger>
                    </Tooltip>
                  </TooltipProvider>
                      ...
                      {isSearching ? (
                        ...
                        <>
                          {allAppsLoading ? (
                            ...
                            <SidebarMenuItem>
                              <div className="flex items-center justify-center py-4">
                                <div className="text-sm text-text-tertiary">No apps found for "{searchQuery}"</div>
                              </div>
                            </SidebarMenuItem>
                          )}
                        </>
                          ...
                          {moreAvailable && (
                            <SidebarMenuItem>
                              ...
                              >
                                ...
                                {!isCollapsed && (
                                  <span className="font-medium text-text-primary/80">View all apps →</span>
                                )}
                              </SidebarMenuButton>
                            </SidebarMenuItem>
                          )}
                        ...
                        <SidebarMenu>
                          ...
                          <SidebarMenuItem>
                            ...
                            >
                              ...
                              {!isCollapsed && (
                                <span className="font-medium text-text-primary/80 ml-2">Browse all boards</span>
                              )}
                            </SidebarMenuButton>
                          </SidebarMenuItem>
                        </SidebarMenu>
