        ...
        <div className="rounded-md w-full max-w-2xl overflow-hidden">
          ...
          >
            ...
            >
              ...
              <div
                className={clsx('flex items-center mt-4 pt-1', showModeSelector ? 'justify-between' : 'justify-end')}
              >
                {showModeSelector && (
                  <ProjectModeSelector
                    value={projectMode}
            ...
            >
              <div className="flex items-start gap-2 px-4 py-3 rounded-xl bg-bg-4/50 dark:bg-bg-2/50 border border-accent/20 dark:border-accent/30 shadow-sm">
                ...
                <p className="text-xs text-text-tertiary leading-relaxed">
                  <span className="font-medium text-text-secondary">Images Beta:</span> Images guide app layout and
                  design but may not be replicated exactly. The coding agent cannot access images directly for app
                  assets.
                </p>
              </div>
            </motion.div>
          ...
          {discoverReady && (
            ...
            >
              <div className="flex flex-col items-start">
                ...
                <motion.div layout transition={{ duration: 0.4 }} className="grid grid-cols-2 xl:grid-cols-3 gap-6">
