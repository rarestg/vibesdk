      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="flex items-center gap-3 px-6 h-12 bg-bg-2 border-b border-border-primary">
          ...
          <div className="flex items-center gap-3 flex-1">
            <span className="text-sm font-medium text-text-primary">{activeFile?.filePath || 'Documentation'}</span>
          ...
          <div className="flex items-center gap-2 export-button-container">
            <ExportButton
              ...
              disabled={!activeFile}
            />
            <ExportButton icon={FileDown} onClick={handlePrint} tooltip="Print to PDF" disabled={!activeFile} />
          </div>
        </div>
        ...
        <div className="flex-1 flex overflow-hidden">
          ...
          {tableOfContents.length > 0 && (
            <div className="w-56 border-l border-border-primary bg-bg-2 overflow-y-auto py-6 px-4">
              <h4 className="text-xs font-semibold text-text-secondary uppercase tracking-wider mb-3">On This Page</h4>
              <nav>
