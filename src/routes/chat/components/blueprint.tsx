    ...
    <div className={clsx('w-full flex flex-col', className)} {...props}>
      ...
      <div className="flex flex-col px-6 py-4 bg-bg-2 rounded-b-xl space-y-8">
            ...
            <div className="space-y-4">
              {phasicBlueprint.userFlow.uiLayout && (
                <div>
                  ...
                  <Markdown className="text-sm text-text-50">{phasicBlueprint.userFlow.uiLayout}</Markdown>
                </div>
              )}
              ...
              {phasicBlueprint.userFlow.uiDesign && (
                <div>
                  ...
                  <Markdown className="text-sm text-text-50">{phasicBlueprint.userFlow.uiDesign}</Markdown>
                </div>
              )}
              ...
              {phasicBlueprint.userFlow.userJourney && (
                <div>
                  ...
                  <Markdown className="text-sm text-text-50">{phasicBlueprint.userFlow.userJourney}</Markdown>
                </div>
              )}
            </div>
          </div>
        ...
        {phasicBlueprint?.initialPhase && (
          <div>
            <h3 className="text-sm font-medium mb-2 text-text-50/70 uppercase tracking-wider">Initial Phase</h3>
            <div className="space-y-3">
              <div>
                <h4 className="text-xs font-medium mb-2 text-text-50/70">{phasicBlueprint.initialPhase.name}</h4>
                <Markdown className="text-sm text-text-50 mb-3">{phasicBlueprint.initialPhase.description}</Markdown>
                {Array.isArray(phasicBlueprint.initialPhase.files) && phasicBlueprint.initialPhase.files.length > 0 && (
                  <div>
                    <h5 className="text-xs font-medium mb-2 text-text-50/60">Files to be created:</h5>
