...
export default function Chat() {
  ...
  const [view, setView] = useState<'editor' | 'preview' | 'docs' | 'blueprint' | 'terminal' | 'presentation'>('editor');
                    ...
                    <div className="absolute right-1 top-1">
                      <DropdownMenu>
                        <DropdownMenuTrigger asChild>
                          <Button variant="ghost" size="icon" className="hover:bg-bg-3/80 cursor-pointer">
              ...
              {otherMessages
                ...
                .map((message) => (
                  <div key={message.conversationId} className="mb-4">
                    <AIMessage message={message.content} isThinking={true} toolEvents={message.ui?.toolEvents} />
                  </div>
                ))}
