              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  {isEditing ? (
                    ...
                    <p className="text-sm text-text-tertiary">{user?.bio || 'No bio provided'}</p>
                  )}
                </div>
              </CardContent>
            </Card>
                  ...
                  <div className="space-y-4">
                    {recentApps.slice(0, 5).map((app) => (
                      ...
                      >
                        ...
                        <Badge variant={app.visibility === 'public' ? 'default' : 'secondary'}>{app.visibility}</Badge>
                      </div>
                    ))}
                  </div>
                ) : (
                        ...
                        <div key={index} className="p-4 rounded-lg border hover:shadow-md transition-shadow">
                          <div className="flex items-start gap-4">
                            ...
                            <div className="flex-1">
                              ...
                              <p className="text-sm text-text-tertiary mt-1">Achievement unlocked!</p>
                            </div>
                          </div>
                        </div>
                      );
